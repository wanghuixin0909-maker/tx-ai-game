...
export default function App() {
  ...
  return (
    <main className="relative h-dvh overflow-x-hidden overflow-y-auto px-3 py-4 text-slate-50 sm:px-5 sm:py-5 lg:overflow-hidden lg:px-8">
      ...
      <div className="relative mx-auto flex h-[calc(100dvh-2rem)] min-h-0 w-full max-w-[1700px] flex-col gap-4 sm:h-[calc(100dvh-2.5rem)]">
